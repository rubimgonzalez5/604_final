...
The model I used was Ordinal Logistic Regression since all of my important variables are ordered categorical variables (i.e. not at all worried, not very worried, somewhat worried, very worried) rather than continuous numbers (Cheng Hua, 2021). I also added the control variables to make sure any changes in the worry are due to the variables that are being tested (the level of harm) and not something else (like education).

* Control variables I used: happening, caused by human activities, generation, and education.
...
Additionally, the results for when people believed climate change was going to harm the US were somewhat surprising as well since 100 years was significant but 25 or 50 years was not.
